...
//		SIPM(int NumClust, int sd);//конструктор класса, в него включить создание файлов? проверки? 
	SIPM_device(){ 
...
int TriggerDelay(int ch,int nreq,int data) ;
...
int SetPlusPower(int RDAC,int comm,int data);
//==========================================================
//===========================================================================
